      ...
      <div className="global__container">
        ...
        <div className={styles.terms__wrapper}>
          ...
          <p className={styles.terms__block}>
            <span>RS3ORE</span> may request additional documentation for certain
            orders to verify the legitimacy of your payment such as:
          </p>
          ...
          <p className={styles.terms__block}>
            These documents will help <span>RS3ORE</span> determine whether the
          ...
          <p className={styles.terms__block}>
            ...
            <span>RS3ORE</span> of any responsibility. Furthermore, once the
            gold has been delivered to you, it becomes your responsibility.
          </p>

          <p className={styles.terms__block}>
            By purchasing goods on <span>RS3ORE</span> you accept all risks
            associated with your in-game account/wealth.
          </p>

          <p className={styles.terms__block}>
            The use of VPN/Proxy/VPS services are prohibited on RS3ORE.
          </p>
          ...
          <ul className={styles.terms__list}>
            ...
            <li>
              Re-selling of accounts purchased from www.RS3ORE.com iinstantly
          ...
          <p className={styles.terms__block}>
            ...
            owners. <span>RS3ORE</span> has no affiliation with Runescape,
